...
// AppError represents an application error with HTTP status codes
// This is used to standardize error handling across the application
...
func getStack() []string {
	...
	for i := 2; i < 10; i++ {
		...
		if strings.Contains(fn.Name(), "github.com/guileen/metabase") {
